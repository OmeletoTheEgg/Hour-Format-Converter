...
public class Background extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        w = getWidth();
        h = getHeight();
        Color color1 = new Color(131, 194, 3);
        Color color2 = new Color(179, 194, 3);
    	...
    	for (int i = 0; i <= dotCount; i++) {
    		for (int j = i; j <= dotCount; j++) {
    			...
    			g2d.setColor(new Color(179, 194, 3, alpha).brighter());
    		...
    		g2d.setColor(new Color(179, 194, 3, 150).brighter());
